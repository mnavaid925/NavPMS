...
1) I want to create "Manufacturing/Production Management System" application in Django as backend and bootstarp 5 as frontend.
...
5) Please create user management, user invite and user profile.
6) Please create proper migrations for all tables.
7) Please add fake data via seeders.
8) You also review the following "C:\xampp\htdocs\navhrm" aplication for UI design. I need to exact same.
9) Create .env file for database connection via MySQL Xampp.
...
I have multiple modules in my MSM application. Below I am giving my first module.
